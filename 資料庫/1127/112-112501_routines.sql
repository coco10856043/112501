...
BEGIN
	...
	update cal_record_day set record_date = current_date();
	update cal_record_day set tot_cal = 0;
    call safe_on();
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
BEGIN
    ...
    -- 清除當日資料
	delete from game;
    update daily_score set score = 0;
    call safe_on();
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
BEGIN
    ...
    select month(now()) as month, id, 0 as tot_cal from user_information;
    call safe_on();
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
