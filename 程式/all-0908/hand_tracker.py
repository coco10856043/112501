...
# -----------------------------------------
# 跳轉程式改93、124、254
# subprocess.run(["python", "AR_login_FINAL.py"])
# "AR_login_FINAL.py"把這串改掉就好
# -----------------------------------------
...
while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
        ...
        if hand_x < 0.33:
            ...
            #-----------------------------------------
            image_resized_4 = cv2.resize(image4, (235, 100))  # 調整圖片大小
            ...
            #-----------------------------------------
            image_resized_6 = cv2.resize(image6, (235, 100))  # 圖片大小
            ...
            #-----------------------------------------
            image_resized_5 = cv2.resize(image5, (235, 100))  # 調整圖片大小
