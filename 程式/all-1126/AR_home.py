...
class initface():
    def __init__(self, master):
        ...
        tip = Label(text='Tips',fg='white', font=('Arial', 15))
        tip.config(bg='cornflowerblue')
        tip.place(x=50, y=570)
        tip_con = Label(text=formatted_text,fg='white')
        tip_con.config(bg='cornflowerblue')
    ...
    def PLAY(self,):   
        ...
        subprocess.run(["python", "hand_tracker.py", result_from_get_account])
...
class face1():
    def __init__(self,master):
        ...
        def updateset():
            ...
            if set_value8 != 0:
                query10 = "select * from user_have where user_id = %s and game_type = 3 and `group` = %s;"
            ...
            if set_count != 0 and set_update == True:
                self.conn.commit()
                self.conn.close()
                initface(self.master) 
            else:
        ...
        log_out.config(image=self.log_out_img)
        log_out.place(x=620,y=550,width=100,height=35)

        self.had1 = PhotoImage(file="png/icon-1.png")
        self.had2 = PhotoImage(file="png/icon-2.png")
        self.had3 = PhotoImage(file="png/icon-3.png")
        self.game11 = PhotoImage(file="game_png/baseball.png")
        self.game12 = PhotoImage(file="game_png/basketball.png")
        self.game13 = PhotoImage(file="game_png/masterball.png")
        self.game21 = PhotoImage(file="game_png/Rat-1.png")
        self.game22 = PhotoImage(file="game_png/Ratt-1.png")
        self.game23 = PhotoImage(file="game_png/Rattt-1.png")
        self.game31 = PhotoImage(file="game_png/cat_1.png")
        self.game32 = PhotoImage(file="game_png/ghost_1.png")
        self.game33 = PhotoImage(file="game_png/slime_1.png")
