...
# 載入遊戲圖片
player_img = pygame.image.load("game_png/player.png")
...
# ------------------------------
if result_list[12] == '1':
    obstacle_images = [pygame.image.load("game_png/cat_1.png")]
elif result_list[12] == '2':
    obstacle_images = [pygame.image.load("game_png/ghost_1.png")]
else:
    obstacle_images = [pygame.image.load("game_png/slime_1.png")]
...
while running:
    ...
    if player_rect.colliderect(obstacle_rect):
        if obstacle_img.get_height() == 100:  # 高度
            # 碰撞之後改變圖示
            if result_list[12] == '1':
                obstacle_img = pygame.image.load("game_png/cat_2.png")
            elif result_list[12] == '2':
                obstacle_img = pygame.image.load("game_png/ghost_2.png")
            else:
                obstacle_img = pygame.image.load("game_png/slime_2.png")

        print("Game Over!")
        print("Score:", score)
        initface_cursor= conn.cursor()
        query1 = "INSERT INTO game (`user_id`, `game_type`, `game_time`, `scores`) VALUES (%s, '3', current_timestamp(), %s);"
