...
# 載入背景圖片
background = cv2.imread("game_png/score_bg.png")
...
# 載入圖片
image_net = cv2.imread('game_png/net.png', cv2.IMREAD_UNCHANGED)
...
# 載入圖片
if result_list[10] == '1':
    image_ball = cv2.imread('game_png/baseball.png', cv2.IMREAD_UNCHANGED)
elif result_list[10] == '2':
    image_ball = cv2.imread('game_png/basketball.png', cv2.IMREAD_UNCHANGED)
else:
    image_ball = cv2.imread('game_png/masterball.png', cv2.IMREAD_UNCHANGED)
