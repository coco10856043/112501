...
class initface():
    def __init__(self,master):
        ...
        # 登入底圖
        self.img2 = PhotoImage(file="login_bg.png")
...
class face1():
    def __init__(self,master):
        ...
        self.re_btn = PhotoImage(file="re_bt_bg.png")
