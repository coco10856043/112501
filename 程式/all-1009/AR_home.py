...
class initface():
    def __init__(self, master):
        ...
        self.surface = PhotoImage(file="home.png")
        ...
        self.had1 = PhotoImage(file="icon-1_40.png")
        self.had2 = PhotoImage(file="icon-2_40.png")
        self.had3 = PhotoImage(file="icon-3_40.png")
        ...
        # 圖表顯示鈕(缺底圖)
        self.chart_btn = PhotoImage(file="chart.png")
...
class face2():
    def __init__(self,master):
        ...
        # 底圖
        self.img2 = PhotoImage(file="buy_bg_2.png")
        bg = Canvas(width=1200, height=700)
        bg.create_image(0, 0, anchor=NW, image=self.img2)   # 在 Canvas 中放入圖片
        bg.place(x=0,y=0)

        # 商品圖
        self.shop_1 = PhotoImage(file="shop-1.png")
        self.shop_2 = PhotoImage(file="shop-2.png")
        self.shop_3 = PhotoImage(file="shop-3.png")
        ...
        # 返回鈕
        self.goback = PhotoImage(file="back.png")
        ...
        self.buy_img = PhotoImage(file="buy.png")
...
class face1():
    def __init__(self,master):
        ...
        # 底圖
        self.img2 = PhotoImage(file="re_bg.png")
        bg = Canvas(width=1200, height=700)
        bg.create_image(0, 0,anchor=NW, image=self.img2)   # 在 Canvas 中放入圖片
        ...
        self.save_img = PhotoImage(file="save.png")
        ...
        self.log_out_img = PhotoImage(file="logout.png")
        ...
        self.had2 = PhotoImage(file="icon-2.png")
        self.had3 = PhotoImage(file="icon-3.png")
        self.game11 = PhotoImage(file="baseball.png")
        self.game12 = PhotoImage(file="basketball.png")
        self.game13 = PhotoImage(file="masterball.png")
        self.game21 = PhotoImage(file="Rat-1.png")
        self.game22 = PhotoImage(file="Ratt-1.png")
        self.game23 = PhotoImage(file="Rattt-1.png")
        self.game31 = PhotoImage(file="cat_1.png")
        self.game32 = PhotoImage(file="ghost_1.png")
        self.game33 = PhotoImage(file="slime_1.png")
...
class face3():
    def __init__(self,master):
        ...
        subprocess.run(['python', 'hand_tracker.py', str(result_list)])
